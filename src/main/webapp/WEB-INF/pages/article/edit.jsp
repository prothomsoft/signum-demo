...
<title><spring:message code="article.editform" text="Edit Form" /></title>
<script>
...
<body>
    <div class="modal-header">
        ...
        <h4 class="modal-title"><spring:message code="article.editentry" text="Edit Entry" /></h4>
    </div>
